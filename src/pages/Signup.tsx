        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4 overflow-hidden relative">
            ...
            <div className="w-full max-w-md space-y-8 animate-in fade-in zoom-in duration-500 relative z-10">
                <div className="text-center space-y-2">
                    <div className="inline-flex items-center justify-center p-3 mb-4 rounded-2xl bg-primary/10 border border-primary/20 text-primary animate-pulse">
                        <Shield className="w-8 h-8" />
                    </div>
                    <h1 className="text-4xl font-black tracking-tight text-foreground">
                        Join <span className="text-primary italic">ZigZup</span>
                    </h1>
                    <p className="text-muted-foreground font-medium">Create your collaborative workspace in seconds.</p>
                </div>
